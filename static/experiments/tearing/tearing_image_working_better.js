...
let visualWidth = 240 * scaler;
let visualHeight = 240 * scaler;
...
function Tear() {
  ...
  this.spreadSize = .6+Math.random()*.4;
  ...
  this.spread = function() {
    ...
    if (this.image2) {
      ...
      let p = [-visualWidth/2,-visualHeight/2];
      let b = p[1] - this.pm * p[0];
      let x2 = p[0] - Math.cos(this.angle)*(this.spreadIterations/(maxSize*this.spreadSize/12));
      let y2 = x2 * this.pm + b;
